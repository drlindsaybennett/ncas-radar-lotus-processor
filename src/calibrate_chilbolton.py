...
start_times=[20161101093004,20170515090847,20170515100631,20170614000130, 20180111173507, 20180328095415, 20180420000401, 20180509123544]
end_times=[20170515084911, 20170515094914, 20170611235341, 20171215103708, 20180328092052,20180416154650, 20180509112845, 20180604145537]
...
for file_chunk in chunks(files,72):
    ...
    os.system(' '.join(['~/lrose/ncas-radar-lotus-processor/src/calibrate_chilbolton.sh', str(params_index), str(chunk_index)] + file_chunk))
    #print(' '.join(['~/lrose/ncas-radar-lotus-processor/src/calibrate_chilbolton.sh', str(params_index), str(chunk_index)] + file_chunk))
